...
namespace Controllers{
    public class LogisticaController{
        public static void Create(DateTime data, int quantidade, string produtoid, string estoqueid){
        ...
        public static void Update(string idRef, DateTime data, int quantidade, string produtoid, string estoqueid){
            int id = 0;
            try{
                id = int.Parse(idRef);
            } catch (Exception e){
